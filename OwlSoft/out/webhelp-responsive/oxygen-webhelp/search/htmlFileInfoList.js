fil = new Array();
fil["0"]= "FAQ.html@@@Frequently Asked Questions@@@Answers to your frequently asked questions about Dashboard...";
fil["1"]= "c_architecture_combined.html@@@Alfresco EnterpriseCMS features and benefits@@@EnterpriseCMS components work together to give you the advanced cluster management and reporting capabilities that you need within a large computing environment...";
...
fil["4"]= "c_mv_about_mobileview.html@@@About Dashboard@@@An overview of Dashboard, the system operator application for EnterpriseCMS...";
...
fil["8"]= "c_mv_organization.html@@@How Dashboard is organized@@@Dashboard is organized according to system operator tabs...";
fil["9"]= "c_mv_performance_tab.html@@@System performance@@@Dashboard reports on system performance...";
...
fil["17"]= "t_mv_logging_on.html@@@Logging on to Dashboard@@@To log on to Dashboard,\n        you must open the Dashboard application and connect to the Cloud Sync server...";
